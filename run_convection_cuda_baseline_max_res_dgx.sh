...
#SBATCH --output=%j_convection_baseline_dgx.out
...
./examples/convection/convection_cuda_baseline_dgx /scratch/hpc-lco-kenter/tstoehr/sycl-stencil/examples/convection/experiments/max-res-default.json /scratch/hpc-lco-kenter/tstoehr/sycl-stencil/build/out
